...
<div class="row member-page-container">
    ...
    <div class="col-lg-12 col-md-4 col-xl-4">
        <div class="card">
            ...
            <div class="card-body">
                <a class="btn" href="<?= '?view=showMember&op=test' ?>">
                    <div id="traffic-chart">Faire le test de niveau</div>
                </a>
            </div>
            <div class="card-body">
                <a class="btn" href="<?= '?view=beginner' ?>">
                    <div id="traffic-chart">DÉBUTANT</div>
                </a>
            </div>
            <div class="card-body">
                <a class="btn" href="<?= '?view=intermediate' ?>">
                    <div id="traffic-chart">INTERMÉDIAIRE</div>
                </a>
            </div>
            <div class="card-body">
                <a class="btn" href="<?= '?view=advanced' ?>">
                    <div id="traffic-chart">AVANCÉ</div>
                </a>
            </div>
        </div>
    </div>
